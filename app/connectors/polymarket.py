...
class PolymarketConnector:
    ...
    async def fetch(self) -> list[CanonicalMarket]:
        ...
        except Exception as exc:  # noqa: BLE001 — isolate venue failure
    ...
    def _normalize(self, item: dict) -> CanonicalMarket | None:
        ...
        slug_for_link = event_slug or market_slug
        deep_link = (
            f"https://polymarket.com/event/{slug_for_link}" if slug_for_link else None
        )
